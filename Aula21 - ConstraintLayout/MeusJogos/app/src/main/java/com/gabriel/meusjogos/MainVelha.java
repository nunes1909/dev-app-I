...
public class MainVelha extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_velha);
    ...
    private void ganhador(String win){
        AlertDialog.Builder builder = new AlertDialog.Builder(MainVelha.this);
